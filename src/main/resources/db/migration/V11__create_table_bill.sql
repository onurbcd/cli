CREATE TABLE IF NOT EXISTS public.bill (
    ...
    CONSTRAINT fk_bill_document_id_1 FOREIGN KEY (bill_document_id) REFERENCES public.document (id) MATCH SIMPLE ON UPDATE NO ACTION ON DELETE NO ACTION,
    CONSTRAINT fk_bill_bill_type_id FOREIGN KEY (bill_type_id) REFERENCES public.bill_type (id) MATCH SIMPLE ON UPDATE NO ACTION ON DELETE NO ACTION,
    CONSTRAINT fk_bill_day_id_1 FOREIGN KEY (document_date_id) REFERENCES public.day (id) MATCH SIMPLE ON UPDATE NO ACTION ON DELETE NO ACTION,
    CONSTRAINT fk_bill_day_id_2 FOREIGN KEY (due_date_id) REFERENCES public.day (id) MATCH SIMPLE ON UPDATE NO ACTION ON DELETE NO ACTION,
    CONSTRAINT fk_bill_day_id_3 FOREIGN KEY (payment_date_id) REFERENCES public.day (id) MATCH SIMPLE ON UPDATE NO ACTION ON DELETE NO ACTION,
